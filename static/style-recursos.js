...
$(document).ready(function() {
    //Horizontal Tab
    $('.tab-horizontal').easyResponsiveTabs({
        type: 'default', //Types: default, vertical, accordion
        width: 'auto', //auto or any width like 600px
        fit: true, // 100% fit in a container
        tabidentify: 'hor-tab', // The tab groups identifier
    ...
    $('.tab-vertical').easyResponsiveTabs({
        ...
        width: 'auto',
        fit: true,
        tabidentify: 'ver-tab', // The tab groups identifier
    });
    //Vertical Tab
    $('.parentVerticalTab').easyResponsiveTabs({
        ...
        tabidentify: 'hor_tab', // The tab groups identifier
        activate: function(event) { // Callback function if tab is switched
            var $tab = $(this);
...
// ACCORDION
$('#body, .body').on('click', '.item_accordion', function() {
